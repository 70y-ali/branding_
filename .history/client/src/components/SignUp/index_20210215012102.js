    ...
    return (
        <div>
            <div className='row' onClick={register}>
                ...
                <input type='text' className='rounded-border' placeholder='Username' onChange={(e) => {setusernameReq(e.target.value)}}></input>
                <label>password</label>
                <input type='password' className='rounded-border' placeholder='Password' onChange={(e) => {setpasswordReq(e.target.value)}}></input>
                <div className='row'>
